...
class AbstractOrder(AbstractCommonField):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE,
                             related_name='orders')
    inquiry = models.OneToOneField('procure.Inquiry', on_delete=models.CASCADE,
                                   related_name='order')
    propose = models.OneToOneField('procure.Propose', on_delete=models.CASCADE,
